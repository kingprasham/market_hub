/**
 * Google Apps Script ΓÇô Per-Cell Timestamp Tracker for Market Hub Spot Prices
 *
 * PURPOSE:
 ...
 *   2. Go to Extensions ΓåÆ Apps Script
 *   3. Delete any existing code and paste this entire file
 *   4. Click the clock icon (Triggers) ΓåÆ Add Trigger:
 ...
 * - Reduced debounce from 30s ΓåÆ 5s so rapid city edits all trigger notifications.
...
// Webhook (same as the previous script ΓÇö for push notification triggers)
...
// ΓöÇΓöÇΓöÇ Main Trigger ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
function onSheetEdit(e) {
  try {
    ...
    // ΓöÇΓöÇ Write timestamp to _timestamps sheet ΓöÇΓöÇ
    ...
    // ΓöÇΓöÇ Optionally trigger webhook (debounced) ΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Debounced Webhook Call ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
...
// ΓöÇΓöÇΓöÇ Manual Test ΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇΓöÇ
